...
- (void)viewDidLoad
{
    ...
    if (!self.toolbarItems)
    {
        ...
        UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:@"Crop"
        ...
        self.toolbarItems = @[fixedSpace,cancelButton ,flexibleSpace, flexibleSpace,doneButton  ,fixedSpace];
    }
    ...
    if (version.floatValue<7.0) {
        ...
        self.navigationController.toolbar.tintColor = [UIColor colorFromHexCode:@"1B1B1B"];
        
    }
    else{
        self.navigationController.toolbar.tintColor = [UIColor whiteColor];
        
        self.navigationController.toolbar.barTintColor =[UIColor colorFromHexCode:@"1B1B1B"];
    }
