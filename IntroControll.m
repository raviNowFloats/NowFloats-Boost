...
- (id)initWithFrame:(CGRect)frame pages:(NSArray*)pagesArray
{
    ...
    if(self != nil) {
        ...
        [backgroundImage1 setAutoresizingMask: UIViewAutoresizingFlexibleWidth];
        ...
        [backgroundImage2 setAutoresizingMask:UIViewAutoresizingFlexibleWidth];
        ...
        [pageControl setCenter:CGPointMake(frame.size.width/2.0, frame.size.height-25)];
