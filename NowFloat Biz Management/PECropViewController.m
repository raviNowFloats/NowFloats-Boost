...
- (void)viewDidLoad
{
    ...
    if(viewHeight == 480)
    {
         ...
         toolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 420, 320, 44)];
    }
    else
    {

        toolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 494, 320, 79)];
    ...
    UIButton *leftCustom = [[UIButton alloc] initWithFrame:CGRectMake(20, 10, 60, 30)];
    
    UIButton *rightCustom = [[UIButton alloc] initWithFrame:CGRectMake(250, 10, 60, 30)];
    
    [leftCustom setTitle:@"Cancel" forState:UIControlStateNormal];
    
    [leftCustom addTarget:self action:@selector(cancel:) forControlEvents:UIControlEventTouchUpInside];
    
    [leftCustom setTitleShadowColor:[UIColor grayColor] forState:UIControlEventTouchUpInside];
    
    [rightCustom setTitle:@"Done" forState:UIControlStateNormal];
    
    rightCustom.titleLabel.font = [UIFont fontWithName:@"Helvetica-Bold" size:18];
    
    [rightCustom addTarget:self action:@selector(done:) forControlEvents:UIControlEventTouchUpInside];
    
    [leftCustom setTitleShadowColor:[UIColor grayColor] forState:UIControlEventTouchUpInside];
    
   
    [toolBar addSubview:leftCustom];
    [toolBar addSubview:rightCustom];
